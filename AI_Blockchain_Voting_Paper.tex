...
This analysis suggests the proposed system would likely demonstrate strong theoretical resistance to most common attack vectors, with particular strength in preventing double voting and vote tampering through blockchain's immutable ledger. The projected lower detection rate for coercion reflects the inherent challenges in preventing this attack in remote voting scenarios, highlighting an area for continued research.

\subsection{Comparative Analysis}
A theoretical comparison between the proposed AI-blockchain integrated voting system and existing electronic voting approaches provides insight into its potential advantages. Fig. 7 illustrates this comparative analysis across key dimensions.
...
\caption{Theoretical Comparative Analysis of Electronic Voting Systems}
