...
\centering
\begin{tikzpicture}
% Layers - simplified structure
\node[rectangle, draw, fill=gray!10, minimum width=6cm] (l5) at (0,0) {User Interface Layer};
\node[rectangle, draw, fill=gray!10, minimum width=6cm] (l4) at (0,-1.5) {Authentication Layer};
\node[rectangle, draw, fill=gray!10, minimum width=6cm] (l3) at (0,-3) {Blockchain Layer};
\node[rectangle, draw, fill=gray!10, minimum width=6cm] (l2) at (0,-4.5) {AI Services Layer};
\node[rectangle, draw, fill=gray!10, minimum width=6cm] (l1) at (0,-6) {Data Storage Layer};
...
\node[rectangle, draw, fill=blue!10] (bc) at (0,0) {Blockchain Technology};
\node[rectangle, draw, fill=red!10] (ai) at (6,0) {AI Capabilities};

% Integration points - using rectangles instead of circles
\node[rectangle, draw, fill=green!10] (iv) at (3,1.5) {Intelligent Verification};
\node[rectangle, draw, fill=green!10] (ad) at (3,0) {Anomaly Detection};
\node[rectangle, draw, fill=green!10] (oc) at (3,-1.5) {Optimized Consensus};
\node[rectangle, draw, fill=green!10] (ta) at (3,-3) {Transparent Auditing};
...
\centering
\begin{tikzpicture}
% Main process flow - simplified
\node[rectangle, draw, fill=blue!5] (reg) at (0,0) {Registration};
\node[rectangle, draw, fill=blue!5] (auth) at (0,-1.5) {Authentication};
\node[rectangle, draw, fill=blue!5] (vote) at (0,-3) {Voting};
\node[rectangle, draw, fill=blue!5] (verify) at (0,-4.5) {Verification};

% AI and Blockchain elements
\node[rectangle, draw, fill=red!10] (ai1) at (3,0) {AI: ID Verification};
\node[rectangle, draw, fill=yellow!10] (bc1) at (3,-1.5) {Blockchain: Eligibility};
\node[rectangle, draw, fill=yellow!10] (bc2) at (3,-3) {Blockchain: Secure Vote};
\node[rectangle, draw, fill=red!10] (ai2) at (3,-4.5) {AI: Fraud Detection};
...
\draw[->, dashed] (reg) -- (ai1);
\draw[->, dashed] (auth) -- (bc1);
\draw[->, dashed] (vote) -- (bc2);
\draw[->, dashed] (verify) -- (ai2);
\end{tikzpicture}
